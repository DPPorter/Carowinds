...
@Configurable
@TeleOp
public class turretTests extends OpMode {
...
//            topServo.setPosition(0.6);
        ...
        telemetryM.addData("turretError", turretError);
        telemetryM.update();
    ...
    public static double tP, vP, vI, vD, vF = 0;
    private void turretControl(){
        turretMotor.setTargetPosition(turretTarget);
        turretMotor.setPositionPIDFCoefficients(tP);
        turretMotor.setVelocityPIDFCoefficients(vP, vI, vD, vF);
        turretMotor.setPower(turretPower);
        turretMotor.setTargetPositionTolerance(threshold);
